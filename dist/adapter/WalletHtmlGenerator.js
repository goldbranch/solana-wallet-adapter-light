...
exports.createHtmlBase = exports.createHtmlAdapter = void 0;
const createHtmlAdapter = (wl) => {
...
exports.createHtmlAdapter = createHtmlAdapter;
const createHtmlBase = () => {
    // Créez un élément div pour le conteneur principal
    const swalModal = document.createElement('div');
    ...
    // Créez la liste
    const adapterList = document.createElement('ul');
...
exports.createHtmlBase = createHtmlBase;
