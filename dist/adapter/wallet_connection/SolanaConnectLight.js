...
class SolanaConnectLight {
    constructor(config) {
        ...
        const processWallet = (wl) => {
            ...
            elementsCallback.elementToBindConnectAction.addEventListener("click", (e) => (() => __awaiter(this, void 0, void 0, function* () {
                ...
                const event = new CustomEvent(CONNECTION_EVENT, { detail: new WalletAdapter_1.WalletAdapterLight(wallet) });
                document.dispatchEvent(event);
                this.showMenu(false);
            }))().catch((e) => {
    ...
    getWallet() {
        ...
        if (adapter) {
            const w = new WalletAdapter_1.WalletAdapterLight(adapter);
            return w;
        }
        return null;
    }
